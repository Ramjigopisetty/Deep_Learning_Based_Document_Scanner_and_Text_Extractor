...
const exportPDF = () => {
  ...
  pdf.text("AI OCR TEXT SCANNER RESULT", 10, 10);
...
const exportDOCX = async () => {
  const doc = new Document({
    sections: [
      {
        children: [
          new Paragraph("AI OCR TEXT SCANNER RESULT"),
          new Paragraph(" "),
    ...
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tight text-slate-900">TEXT SCANNER</h1>
            <p className="text-xs text-slate-500 font-medium uppercase tracking-wider">AI Powered Document Scanning & OCR System</p>
          </div>
        </div>
      ...
      <footer className="max-w-7xl mx-auto px-6 py-12 border-t border-slate-200 mt-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-slate-900">TEXT SCANNER</span>
